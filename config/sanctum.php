...
return [
    ...
    */
    ...
    /*
     * Include host **with port** when using php artisan serve --port=8004 (etc.).
     * Browsing http://127.0.0.1:8004 while only 127.0.0.1:8000 is listed → SPA API calls get 401.
     */
