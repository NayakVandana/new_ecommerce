        ...
        <>
            ...
            <nav className="flex flex-1 flex-col gap-0.5 overflow-y-auto">
                ...
                <NavLink
                    ...
                    active={route().current('admin.coupon-usages.index') ?? false}
                    icon={IconTicket}
                    onClick={onNavigate}
                >
                    Coupon usage
                ...
                <NavLink
                    ...
                    active={route().current('admin.recently-viewed.index') ?? false}
                    icon={IconEye}
                    onClick={onNavigate}
                >
                    Recently viewed
                ...
                <NavLink
                    ...
                    active={route().current('admin.wishlist.index') ?? false}
                    icon={IconHeart}
                    onClick={onNavigate}
                >
                    Wishlist
